...
namespace act.ui.EmojiText
{
    ...
    public class UiEmojiText : Text, IPointerClickHandler
    {
        ...
        //文本表情管理器
        private EmojiManager _inlineManager;
        ...
        protected override void OnEnable()
        {
            ...
            if (_inlineManager == null)
                _inlineManager = GetComponentInParent<EmojiManager>();
        ...
        public override float preferredWidth
        {
            get
            {
                ...
                return width;// < rectTransform.rect.size.x || horizontalOverflow == HorizontalWrapMode.Overflow ? width : rectTransform.rect.size.x;
            }
        }
        public override float preferredHeight
        {
            get
            {
                ...
                return height < rectTransform.rect.size.y || verticalOverflow == VerticalWrapMode.Overflow ? height : rectTransform.rect.size.y;
            }
        }
